...
from dissect.database.ese.c_ese import PAGE_FLAG, TAGFLD_HEADER, c_ese
...
class RecordData:
    ...
    def __init__(self, table: Table, node: Node):
        ...
        if len(self.data) >= 4:
            self.header = c_ese.RECHDR(self.data)
...
class TagField:
    ...
    def is_null(self) -> bool:
        ...
        if self.record.db.has_small_pages:
